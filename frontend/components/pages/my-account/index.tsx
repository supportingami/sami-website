...
//     updateUser(input: { where: { id: $userId }, data: { username: $username } }) {
//       user {
//         id
//         username
//       }
...
const MyAccountPageComponent = () => {
  ...
  // const [updateUser, { loading: updateUserFetching, error: updateUserError }] = useMutation(updateUserMutation);
      ...
      <Grid templateColumns="repeat(1, 1fr)" gap={4}>
        <Box p={4} bg={bgColor[colorMode]} color={color[colorMode]} shadow="sm" rounded="lg">
          <Stack spacing={4}>
            ...
            <FormControl>
              <Button loadingText="Saving..." onClick={handleSubmit} isLoading={updateUserFetching}>
                Save
              </Button>
            </FormControl>
          </Stack>
